#composite model is multi-label i guess
# medium type and environment
#do this way, this works
import numpy as np
...
def createCompositeSVM(x, y, name):
    y_true = []
    y_dec = []
    ...
    tuples= [tuple(x) for x in y.values]
    mlb = MultiLabelBinarizer()
    y = mlb.fit_transform(tuples)
